...
################################################################################
#
#Updating mirrorlist to provide fastest update & install times
#Stop the installation with CTRL + C and run 'mirror' if still slow
# or, uncomment the next 3 lines
#
